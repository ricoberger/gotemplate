// Package errresponse implements a custom error renderer for the api as it is described in the chi rest api example,
// which can be found here: https://github.com/go-chi/chi/blob/master/_examples/rest/main.go
package errresponse
