...
// Setup is used to setup tracing for our app. For that we are creating a new TracerProvider and register it as the
// global so any imported instrumentation will default to using it.
